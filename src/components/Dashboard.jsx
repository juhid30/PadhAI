      ...
      <div className="flex-1 bg-gray-100 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-4 rounded-lg shadow-md">
            ...
            <div className="flex flex-col space-y-2 mb-4 pt-4">
              <div className="h-[4rem] text-white bg-blue-500 rounded-lg flex items-center justify-center">Pending Assignments</div> {/* 5vh height */}
              <div className="h-[4rem] text-white bg-blue-500 rounded-lg flex items-center justify-center">Due Assignments</div> {/* 5vh height */}
              <div className="h-[4rem] text-white bg-blue-500 rounded-lg flex items-center justify-center">Submitted Assignments</div> {/* 5vh height */}
            </div>
        ...
        <div className="flex h-[55vh] gap-6 mt-6">
          ...
          <div className="bg-white p-6 w-[30%] rounded-lg shadow-md flex items-center justify-center">
            <img src={`https://firebasestorage.googleapis.com/v0/b/webcade2024.appspot.com/o/hr-sim.png?alt=media&token=a753ade0-891c-4352-954d-18c5362df112`} alt="" srcset="" className='flex items-center justify-center h-[250px] w-[250px]' />
          </div>
        </div>
      </div>
    </div>
